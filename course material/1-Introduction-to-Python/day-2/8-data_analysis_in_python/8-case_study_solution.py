...
# drop drops the old index, otherwise it is saved as a new column
LdfPubReleases = LdfPubReleases.sort_values('Releases',ascending=False).reset_index(drop = True)
