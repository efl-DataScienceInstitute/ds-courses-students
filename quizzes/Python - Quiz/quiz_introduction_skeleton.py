...
#%%
##Q1: In 2008, which gaming platform had the largest global sales?
...
#%%
##Q2: how many games are new in 2011, i.e., that are not listed in previous years?
##use set operators

#select the unique names of the games in 2011
new_games = df[...]["Name"].

#select the unique names of the games before 2011
old_games = df[...]["Name"].
...
print("We have", number_unique_games, "new unique games in 2011.")




#%%
##Q3: what is the name of the publisher with the longest name?
...
#%%
##Q3.2: what is the name of the publisher with the shortest  name?
#use a for loop
shortest_name = publisher_names[0]
for name in publisher_names:
    if ... :
        ...
    else:
...
#%%
##Q3.3:
#Question: why do we define longest_name and shortest_name differently?
#           Name one reason.
